...
vlesslink1="vless://${uuid}@${domain}:$tls?path=/worryfree/vless&security=tls&encryption=none&type=ws#${user}"
vlesslink2="vless://${uuid}@${domain}:$none?path=/worryfree/vless&encryption=none&type=ws#${user}"
...
echo -e "Path           : /worryfree/vless" | tee -a /etc/log-create-user.log
