...
trojanlink="trojan://${uuid}@${domain}:${tls}?path=%2Fworryfree&security=tls&host=${domain}&type=ws&sni=${domain}#${user}"
trojanlink2="trojan://${uuid}@${domain}:${ntls}?path=%2Fworryfree&security=none&host=${domain}&type=ws#${user}"
